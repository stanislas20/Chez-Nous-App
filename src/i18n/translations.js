export const translations = {
  en: {
    ...
    postingTitleJobs: "Post a job",
    postingTitleCommunity: "Post a notice",
    postingTitleRestaurants: "List my restaurant",
    ...
    driverCountLabel: "{count} provider(s) — {occasion}",
    driverCheapestFirst: "Cheapest first",
    driverAgency: "Agency",
    driverPermitDeclared: "Permit {permits} · declared",
    driverPriceOnAsking: "Price to be agreed",
    driverSeats: "{count} passengers",
    driverAirConditioned: "air-conditioned",
    driverSpeaks: "Speaks: {langs}",
    driverNoneForOccasion: "No provider for this arrangement yet",
    driverNoDriversCopy:
      "This list fills as drivers publish. Anyone who left a field blank still appears — an empty answer is treated as unknown, not as no.",
    driverPriceWarning:
    ...
    sellFieldDriverOccasions: "What you offer",
    sellDriverOccasionsHint:
      "Tick only what you actually do. Each one is priced differently and clients filter on them.",
    sellFieldDriverPrices: "Your price for each",
    sellDriverPricesHint:
      "In FCFA. Leave one blank and your card says the price is to be agreed — it does not read as cheap, it sorts last.",
    sellFieldDriverIncluded: "What the price includes",
    sellDriverIncludedHint:
      "e.g. Fuel and tolls included · 10 hours and 120 km.",
    sellFieldDriverExcluded: "What it does not include",
    sellDriverExcludedHint:
      "The line that prevents the argument: beyond the hours, fuel, the driver's night away.",
    sellFieldDriverVehicleMode: "Whose vehicle",
    sellFieldDriverVehicle: "Your vehicle",
    sellDriverVehiclePlaceholder: "e.g. Toyota Corolla 2019",
    sellFieldDriverSeats: "Passenger seats",
    sellFieldDriverAc: "Air-conditioned",
    ...
    papersAttention: "{count} to deal with",
    papersExpired: "Expired {days} days ago",
    papersSoon: "Expires in {days} days",
    papersValid: "Valid",
    papersHeld: "Recorded as held",
    papersNotHeld: "Not recorded",
    papersNoDate: "No date entered",
    papersUntil: "Until {date}",
    papersAddPrompt: "Add the date to see it counted down",
    papersAdd: "Add",
    papersChange: "Change",
    papersMark: "I have it",
    papersHeldShort: "Held",
    papersSheetCopy:
      "Copy the expiry date from the document itself. A date remembered from memory is the one that gets you stopped.",
    papersDay: "Day",
    papersMonth: "Month",
    papersYear: "Year",
  ...
  fr: {
    ...
    postingTitleJobs: "Publier une offre d’emploi",
    postingTitleCommunity: "Publier une annonce",
    postingTitleRestaurants: "Inscrire mon restaurant",
    ...
    driverCountLabel: "{count} prestataire(s) — {occasion}",
    driverCheapestFirst: "Du moins cher",
    driverAgency: "Agence",
    driverPermitDeclared: "Permis {permits} · déclaré",
    driverPriceOnAsking: "Prix à convenir",
    driverSeats: "{count} passagers",
    driverAirConditioned: "climatisé",
    driverSpeaks: "Parle : {langs}",
    driverNoneForOccasion:
      "Aucun prestataire sur cette prestation pour l’instant",
    driverNoDriversCopy:
      "Cette liste se remplit au fur et à mesure des publications. Un prestataire qui a laissé un champ vide apparaît quand même : une réponse absente est traitée comme inconnue, pas comme un non.",
    driverPriceWarning:
    ...
    sellFieldDriverOccasions: "Ce que vous proposez",
    sellDriverOccasionsHint:
      "Ne cochez que ce que vous faites vraiment. Chaque prestation se facture différemment et les clients filtrent dessus.",
    sellFieldDriverPrices: "Votre tarif pour chacune",
    sellDriverPricesHint:
      "En FCFA. Laissez vide et votre fiche affiche « prix à convenir » — ce n’est pas lu comme pas cher, c’est classé en dernier.",
    sellFieldDriverIncluded: "Ce que le prix comprend",
    sellDriverIncludedHint: "ex. Carburant et péages compris · 10 h et 120 km.",
    sellFieldDriverExcluded: "Ce qu’il ne comprend pas",
    sellDriverExcludedHint:
      "La ligne qui évite la dispute : au-delà des heures, le carburant, la nuitée du chauffeur.",
    sellFieldDriverVehicleMode: "Quel véhicule",
    sellFieldDriverVehicle: "Votre véhicule",
    sellDriverVehiclePlaceholder: "ex. Toyota Corolla 2019",
    sellFieldDriverSeats: "Places passagers",
    sellFieldDriverAc: "Climatisé",
    ...
    papersAttention: "{count} à traiter",
    papersExpired: "Expiré depuis {days} jours",
    papersSoon: "Expire dans {days} jours",
    papersValid: "En règle",
    papersHeld: "Enregistrée comme détenue",
    papersNotHeld: "Non renseignée",
    papersNoDate: "Aucune date saisie",
    papersUntil: "Jusqu’au {date}",
    papersAddPrompt: "Ajoutez la date pour voir le compte à rebours",
    papersAdd: "Ajouter",
    papersChange: "Modifier",
    papersMark: "Je l’ai",
    papersHeldShort: "Détenue",
    papersSheetCopy:
      "Recopiez la date d’expiration sur le document lui-même. Une date retenue de mémoire est celle qui vous fait arrêter.",
    papersDay: "Jour",
    papersMonth: "Mois",
    papersYear: "Année",
    papersDateHint:
